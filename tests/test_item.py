...
from src.item import Item, CSV_PATH, InstantiateCSVError
...
class TestItem:
    ...
    def test_file_not_found_error(self):
        with pytest.raises(FileNotFoundError):
            Item.instantiate_from_csv("несуществующий_файл.csv")

    # TestCase #9
    def test_instantiate_csv_error(self):
        csv_path = "tests/corrupted_file.csv"
